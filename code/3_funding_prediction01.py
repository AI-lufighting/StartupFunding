...
train_data = pd.read_csv('./train_data01.csv').drop('profile',axis=1)
test_data = pd.read_csv('./test_data01.csv').drop('profile',axis=1)
...
train_data_OverSampler = pd.read_csv('train_data01_oversampler.csv').drop('profile',axis=1)
...
train_data_UnderSampler = pd.read_csv('train_data01_undersampler.csv').drop('profile',axis=1)
